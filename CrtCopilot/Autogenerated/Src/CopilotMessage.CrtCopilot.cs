namespace Creatio.Copilot
{
	...
	[DataContract]
	[Serializable]
	[DebuggerDisplay("Role = {Role}; ContentType = {ContentType}; Content = {Content}")]
	public class CopilotMessage: BaseCopilotMessage
	{
		...
		public CopilotMessage(string content, string role, string toolCallId = null)
			: base(content, role, toolCallId) {
		}

		public CopilotMessage(string content, string role, long ticks, string toolCallId = null)
			: base(ticks, content, role, toolCallId) {
		...
		/// <summary>
		/// Gets or sets a value indicating what tool IDs require confirmation.
		/// </summary>
		[DataMember(Name = "toolCallIdsRequireConfirmation", IsRequired = false)]
		public string ToolCallIdsRequireConfirmation { get; set; }

		/// <summary>
		/// Gets or sets a value indicating whether the tool has been confirmed.
		/// </summary>
		[DataMember(Name = "confirmationResult", IsRequired = false)]
		...
		/// <summary>
		/// Gets or sets the confirmation buttons for the copilot message.
		/// </summary>
		[DataMember(Name = "buttons", IsRequired = false)]
		public List<CopilotMessageButton> Buttons { get; set; }
